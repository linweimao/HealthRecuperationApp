package com.lwm.healthrecuperationapp.api;

public class ApiConfig {
    public static final int PAGE_SIZE = 5; // 分页：每页5条数据
    public static final String BASE_URl = "http://192.168.43.24:8080/renren-fast";
